...
const ChatHeader: React.FC = () => {
    ...
    return (
        <div
            ...
            <CircularImage
                image={CurrentChats?.dmChatUser2.username===username?CurrentChats?.dmChatUser1.profileImage:CurrentChats?.dmChatUser2.profileImage as string}
                size={48}
            />
            <div className={'mx-4 flex flex-col flex-auto justify-center'}>
                <div className={'flex flex-row justify-between'}>
                    <span className={'text-black text-lg font-bold'}>
                        {CurrentChats?.dmChatUser2.username===username?CurrentChats?.dmChatUser1.username:CurrentChats?.dmChatUser2.username}
                    </span>
                </div>
                <div className={'flex flex-row justify-between'}>
