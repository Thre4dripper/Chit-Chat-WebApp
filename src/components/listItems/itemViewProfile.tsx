...
import { ArrowBack, Send, FavoriteBorder, Clear, DeleteOutline,Notifications } from '@mui/icons-material';
...
const ViewProfile:React.FC<{setIsViewing:React.Dispatch<SetStateAction<boolean>>}> = ({setIsViewing})=> {
    ...
    return (
        <div className="bg-slate-900/90 rounded-3xl shadow-md h-full w-full z-50">
            ...
            {/* Medias Section */}
            <div className="p-4">
                <Typography variant="subtitle1" className="font-semibold text-blue-gray-700 mb-2">
                    Medias
                </Typography>
            ...
            <div className="px-4 py-3">
                <Typography variant="subtitle1" className="font-semibold text-blue-gray-700 mb-1">
                    Groups in Common
                </Typography>
