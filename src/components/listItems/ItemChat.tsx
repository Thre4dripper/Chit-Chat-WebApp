...
const ItemChat: React.FC<ItemChatProps> = ({ image, primaryText, secondaryText, time, notification }) => {
    ...
    return (
        <div
            className={"flex flex-row gap-4 px-4 py-2 select-none cursor-pointer hover:bg-slate-900 active:bg-slate-800"}>
            ...
            <div className={"flex flex-col flex-auto justify-center"}>
                ...
                <div className={"flex flex-row justify-between"}>
                    ...
                    <div className={"flex flex-row justify-center items-center"}>
                        <div
                            className={"w-auto px-1 h-5 bg-blue-300/50 rounded-full text-white text-xs flex justify-center items-center"}>
                            {notification}
                        </div>
                    </div>
                </div>
