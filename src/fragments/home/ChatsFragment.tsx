...
const ChatsFragment: React.FC<{openProfile:React.Dispatch<SetStateAction<boolean>>}> = ({openProfile}) => {
  ...
  return (
    <div className={"h-screen flex flex-col"}>
      <div className={"h-14 m-4 flex flex-row"}>
        ...
        <div className={"flex flex-col justify-center rounded-full"} onClick={()=>{openProfile(true)}}>
          <IconButton>
            <Badge
              overlap="circular"
              anchorOrigin={{
