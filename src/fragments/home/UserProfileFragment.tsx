...
const UserProfileFragment:React.FC<{openProfile:React.Dispatch<SetStateAction<boolean>>}>= ({openProfile})=> {
    ...
    return (
          ...
          <div className={`h-full w-full`}>
                ...
                <button onClick={()=>{openProfile(false)}}><ArrowBackIosIcon/> Back</button>
               ...
               <Paper sx={{display:'flex',flexDirection:"column",gap:'1rem'}}>
                 ...
                 <Person2Icon/>
                 <TextField id="username" label="Username" value={userinfo.username} variant="standard" sx={{}} />
                 <ModeEditOutlineIcon/>
                 </Box>
                 <Box sx={{display:'flex',alignItems:'center',justifyContent:'center'}}>
                 <ReportIcon/>
                 <TextField id="name" label="Name" value={userinfo.name} variant="standard" aria-readonly/>
                 <ModeEditOutlineIcon/>
                 </Box>
                 <Box sx={{display:'flex',alignItems:'center',justifyContent:'center'}}>
                 <MenuBookIcon/>
                 <TextField id="boi" label="Bio" value={userinfo.bio} variant="standard" aria-readonly/>
                 <ModeEditOutlineIcon/>
                 </Box>
               </Paper>
          </div>
